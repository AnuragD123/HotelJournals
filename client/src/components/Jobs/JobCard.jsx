...
import './JobCard.css';
import appleIcon from '../../assets/img/Jobs_img/jobs_card/Apple.png';
            ...
            <div className='job-card'>
                <div className="head">
                    <div className="head_box">
                        <div className="employer-logo">
                            <img width="50px" src={appleIcon} alt="apple" />
                        </div>
                ...
                <div className="card-body">
                    <div className="job-role">
                        ...
                        <small>Java Developer- Full Time</small>
                    </div>
                    <div className="description">
                        Lorem, ipsum dolor sit amet consectetur adipisicing elit. Provident minus, illo dolorem neque quas laboriosam culpa sint laudantium molestias incidunt nobis quidem.
                    </div>
                </div>
